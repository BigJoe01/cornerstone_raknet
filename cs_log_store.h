...
namespace cornerstone {
    class CLogStore {
    __interface_body__(CLogStore)

    public:
        /**
        ** The first available slot of the store, starts with 1
        */
        virtual ulong NextSlot() const = 0;
        ...
        */
        virtual ulong StartIndex() const = 0;
        ...
        */
        virtual CPtr<CLogEntry> LastEntry() const = 0;

        /**
        * Appends a log entry to store
        * @param entry
        */
        virtual ulong Append(CPtr<CLogEntry>& entry) = 0;
        ...
        * @param entry
        */
        virtual void WriteAt(ulong index, CPtr<CLogEntry>& entry) = 0;
        ...
        */
        virtual CPtr<std::vector<CPtr<CLogEntry>>> LogEntries(ulong start, ulong end) = 0;
        ...
        */
        virtual CPtr<CLogEntry> EntryAt(ulong index) = 0;
        ...
        */
        virtual ulong TermAt(ulong index) = 0;
        ...
        * @return log pack
        */
        virtual CPtr<CBuffer> Pack(ulong index, int32 cnt) = 0;
        ...
        * @param pack
        */
        virtual void ApplyPack(ulong index, CBuffer& pack) = 0;
